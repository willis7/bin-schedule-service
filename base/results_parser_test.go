...
func TestResultParser(t *testing.T) {
	...
	if actual := ResultParser(result); actual != expected {
		t.Errorf("ResultParser failed: expected %v, got %v", actual, expected)
	}
